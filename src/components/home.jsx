...
const Home = () => {
    ...
    return (
        <div name="home" className="w-full h-screen ">
            ...
            <div className="flex py-2 scale-150 my-7 flex-col items-center hover:cursor-default">
            ...
            <div className="flex flex-row ">
                <div className="box-content bg-stone-900 w-80 md:px-4 py-2 md:scale-125 scale-90 px-2
