...
const Contact = () => {
  return (
    <div name='contate' className='w-full h-screen'>
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/e68f8267-0a0d-478b-9479-c996c5232d07"
                method='POST' className='flex flex-col w-full mt-5 md:w-1/2'>
                    ...
                    <button className='bg-gradient-to-t from-cyan-500 from-45% to-blue-400/90 px-6 py-2
                    rounded-md hover:px-10 duration-300 cursor-pointer mx-auto my-6'>
                        <div className='flex items-center font-signature font-bold '>
                            Enviar <div><><BiChevronRight size={30}/></></div>
                        </div>
                    </button>
                </form>
            </div>
